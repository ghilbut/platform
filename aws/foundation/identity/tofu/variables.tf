variable "aws_execution_role_arn" {
  ...
  default     = "arn:aws:iam::384959722788:role/tofu-plan"
  nullable    = true
  ...
  validation {
    ...
    error_message = "aws_execution_role_arn must be null or the Management account tofu-plan or tofu-apply role ARN."
  }
}
