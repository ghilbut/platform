variable "aws_execution_role_arn" {
  ...
  default     = "arn:aws:iam::954066442429:role/tofu-plan"
  nullable    = true
  ...
  validation {
    ...
    error_message = "aws_execution_role_arn must be null or the SecurityTooling account tofu-plan or tofu-apply role ARN."
  }
}
